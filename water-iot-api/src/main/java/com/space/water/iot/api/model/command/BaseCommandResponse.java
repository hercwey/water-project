...
public class BaseCommandResponse extends BaseResponse{
	...
	public static String toJsonString(BaseCommandResponse request) {
		return JSON.toJSONString(request);
	}

	public static BaseCommandResponse fromJson(String json) {
		return JSON.parseObject(json, BaseCommandResponse.class);
	}
}
