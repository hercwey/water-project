...
//	public static final String SECRET = "GQzxIbNje7Bg7ICFABkjffu41VEa";
	...
	//应用名称：demo58water
	public static final String APP_ID = "_jtJWhxrwejtUeEuChMbX4VmhGga";
	public static final String SECRET = "5InBGWQnQkx4kLqf3DuI2MPwI0Ua";

	public static final String CALLBACK_BASE_URL = "http://39.107.230.168:8282";
	...
	public static final String DISCOVER_INDIRECT_DEVICE = BASE_URL
			+ "/iocm/app/signaltrans/v1.1.0/devices/%s/services/%s/sendCommand";
	public static final String REMOVE_INDIRECT_DEVICE = BASE_URL
			+ "/iocm/app/signaltrans/v1.1.0/devices/%s/services/%s/sendCommand";
	...
	public static String SELF_CERT_PATH = "/src/main/resources/iot_cert/outgoing.CertwithKey.pkcs12";
	public static String TRUST_CA_PATH = "/src/main/resources/iot_cert/ca.jks";
