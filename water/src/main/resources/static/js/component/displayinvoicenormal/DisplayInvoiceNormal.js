 ...
 * 	dialogId:对话框ID
 */
function DisplayInvoiceNormal(dialogId){
	...
	//发票对象
	this.mInvoice = new InvoiceNormal("invoice-normal-1", InvoiceType.FPZL_NORMAL_INVOICE); //初始化专用发票类型
	this.mInvoice.init(); //初始化编辑组件事件
...
//获取发票对象
DisplayInvoiceNormal.prototype.getInvoice=function(){
 ...
 */
DisplayInvoiceNormal.prototype.setDefault=function(){
 ...
 */
DisplayInvoiceNormal.prototype.initListener=function(){
	var self=this;
...
//------------打开,关闭对话框-----------------
DisplayInvoiceNormal.prototype.show=function(invoiceId){
	var self=this;
	...
	function queryCallback(resp){
		...
		if(resp!=""){
			var invoiceObj=self.mInvoice;  //发票对象(UI+DATA)			
...
DisplayInvoiceNormal.prototype.close=function(){
 ...
 * set title
 */
DisplayInvoiceNormal.prototype.setTitle=function(title){
 ...
 * set message
 */
DisplayInvoiceNormal.prototype.setMessage=function(message){
 ...
 * 	取值:普通发票  专用发票
 */
DisplayInvoiceNormal.prototype.setInvoiceType=function(invoiceType){
 ...
 * 设置发票代码
 */
DisplayInvoiceNormal.prototype.setInvoiceDM=function(invoiceDM){
 ...
 * 设置发票号码
 */
DisplayInvoiceNormal.prototype.setInvoiceHM=function(invoiceHM){
 ...
 */
DisplayInvoiceNormal.prototype.setButtonOkCallback=function(buttonOkCallback){
	this.buttonOkCallback=buttonOkCallback;
}
/**
 * set buttonCancel callback function
 */
DisplayInvoiceNormal.prototype.setButtonCancelCallback=function(buttonCancelCallback){
