 ...
 * @Package com.learnbind.ai.common.enumclass
 *
 * @Title: EnumSendSmsStatus.java
 * @Description: 发送短信结果
 *
 * @author Thinkpad
 * @date 2020年1月18日 下午5:00:47
 * @version V1.0 
 *
 */
public enum EnumSendSmsStatus {
	 ...
	 * @param name
	 */
	private EnumSendSmsStatus(Integer value, String name) {
		this.value = value;
		this.name = name;
	}
	...
	public static String getName(int value) {
		for (EnumSendSmsStatus type : EnumSendSmsStatus.values()) {
