 ...
 *
 */
public enum EnumPartitionWaterStatus {

	/**
	 * @Fields PARTITION_NO：0=是否分水量状态-否
	 */
	PARTITION_NO(0, "否"),
	/**
	 * @Fields PARTITION_YES：1=是否分水量状态-是
	 */
	PARTITION_YES(1, "是");
	 ...
	 * @param name
	 */
	private EnumPartitionWaterStatus(Integer value, String name) {
		this.value = value;
		this.name = name;
	}
	...
	public static String getName(int value) {
		for (EnumPartitionWaterStatus type : EnumPartitionWaterStatus.values()) {
