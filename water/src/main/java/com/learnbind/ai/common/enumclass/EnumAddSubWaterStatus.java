 ...
 *
 */
public enum EnumAddSubWaterStatus {

	ADD_SUB_WATER_NO(0, "否"),
	ADD_SUB_WATER_YES(1, "是");
	 ...
	 * @param name
	 */
	private EnumAddSubWaterStatus(Integer value, String name) {
		this.value = value;
		this.name = name;
	}
	...
	public static String getName(int value) {
		for (EnumAddSubWaterStatus type : EnumAddSubWaterStatus.values()) {
