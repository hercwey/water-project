...
public enum EnumReplyStatus {
	 ...
	 * @param name
	 */
	private EnumReplyStatus(Integer value, String name) {
		this.value = value;
		this.name = name;
	}
	...
	public static String getName(int value) {
		for (EnumReplyStatus type : EnumReplyStatus.values()) {
