 ...
 * 
 * @Package com.learnbind.ai.common.util.excelutil.location
 *
 * @Title: ReadLocationExcel.java
 * @Description: 读取地理位置Excel
 *
 * @author Administrator
 * @date 2019年6月26日 下午6:27:56
 * @version V1.0 
 *
 */
public class ReadLocationExcel {
    
	private static final Log log = LogFactory.getLog(ReadLocationExcel.class);
    ...
    private static Map<String, Object> parseExcelInfoXlsx(XSSFWorkbook xssfWorkbook){
    	...
    	List<String> locationList = new ArrayList<>();//地理位置集合
        ...
        for (int numSheet = 0; numSheet < sheetSize; numSheet++) {
            ...
            for (int rowNum = 1; rowNum <= rowSize; rowNum++) {
                ...
                if (xssfRow != null) {
                	...
                	try {
                		String location = getLocationParm(xssfRow);
        ...
        respMap.put("result_data", JSON.toJSONString(locationList));
        return respMap;
    }
    
    /**
     * @Title: getLocationParm
     * @Description: 获取地理位置对象
     * @param xssfRow
     * @return 
     */
    private static String getLocationParm(XSSFRow xssfRow) {
	...
	private static Map<String, Object> parseExcelInfoXls(HSSFWorkbook hssfWorkbook){
    	...
    	List<String> locationStrList=new ArrayList<>();//地理位置字符串集合 
            ...
            for (int rowNum = 1; rowNum <= rowSize; rowNum++) {
                ...
                if (hssfRow != null) {
                	...
                	try {
                		...
                		String location = getLocationParm(hssfRow);//地理位置字符串
                		locationStrList.add(location);
        ...
        respMap.put("roomList", JSON.toJSONString(locationStrList));
        return respMap;
    }
     ...
     * @return 
     */
    private static String getLocationParm(HSSFRow hssfRow) {
