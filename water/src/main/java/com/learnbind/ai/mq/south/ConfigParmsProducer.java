 ...
 *
 * @Title: ConfigParmsProducer.java
 * @Description: 生产者-下发配置设备参数命令
 *
 * @author SRD
...
//@Component
@AutoConfigureAfter
public class ConfigParmsProducer {

	/**
	 * @Fields log：日志
	 */
	private static final Logger log = LoggerFactory.getLogger(ConfigParmsProducer.class);
	 ...
	 * 通过构造函数 实例化对象
	 */
	public ConfigParmsProducer() throws MQClientException {
		
		String producerGroup = MQConstant.P_G_SORTH_CONFIG_PARMS;//生产者分组
		//示例生产者
	...
	public SendResult sendMsg(String keys, String body) throws MQClientException, RemotingException, MQBrokerException, InterruptedException {
		...
		String tag = rocketTopicConfig.getTagConfigParmsSouth();// tag
