 ...
 */
@Component
public class ConfigParmsConsumer extends BaseConsumer {
	...
	public void initParams() {
		this.consumerGroup = MQConstant.C_G_NORTH_CONFIG_PARMS;// 消费者分组
		this.topicName = rocketTopicConfig.getTopicName();// 主题名称
		this.tag = rocketTopicConfig.getTagConfigParmsNorth();// tag
	}
	@Override
	public void processMessage(String msg) {
		ConfigParamsResponse configParams = ConfigParamsResponse.fromJson(msg);
