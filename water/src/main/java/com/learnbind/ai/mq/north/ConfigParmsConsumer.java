 ...
 * @Package com.learnbind.ai.mq.north
 *
 * @Title: ConfigParmsConsumer.java
 * @Description: 消费者-配置设备参数返回数据
 *
 * @author SRD
 ...
 */
@Component
public class ConfigParmsConsumer {

	/**
	 * @Fields log：日志
	 */
	private static final Logger log = LoggerFactory.getLogger(ConfigParmsConsumer.class);
	...
	public void start() throws MQClientException {
		try {
			...
			String consumerGroup = MQConstant.C_G_NORTH_CONFIG_PARMS;// 消费者分组
			String topicName = rocketTopicConfig.getTopicName();// 主题名称
			String tag = rocketTopicConfig.getTagConfigParmsNorth();// tag
				...
				public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs,
					...
					try {
						for (Message msg : msgs) {
							...
							log.info("消费者分组-配置设备参数返回数据【" + consumerGroup + "】，主题topic【" + msg.getTopic() + "】，tag【" + tag
									+ "】，消费消息【" + body + "】");
