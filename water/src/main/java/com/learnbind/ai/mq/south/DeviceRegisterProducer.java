 ...
 *
 * @Title: DeviceRegisterProducer.java
 * @Description: 生产者-调用IOT电信平台注册设备接口
 *
 * @author SRD
 ...
 */
@Component
public class DeviceRegisterProducer {

	/**
	 * @Fields log：日志
	 */
	private static final Logger log = LoggerFactory.getLogger(DeviceRegisterProducer.class);
	 ...
	 * 通过构造函数 实例化对象
	 */
	public DeviceRegisterProducer() throws MQClientException {
		
		String producerGroup = MQConstant.P_G_SORTH_DEVICE_REGISTER;//生产者分组
		//示例生产者
	...
	public SendResult sendMsg(String keys, String body) throws MQClientException, RemotingException, MQBrokerException, InterruptedException {
		...
		String tag = rocketTopicConfig.getTagDeviceRegisterSouth();// tag
