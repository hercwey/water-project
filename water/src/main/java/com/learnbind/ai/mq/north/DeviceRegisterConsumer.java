 ...
 * @Package com.learnbind.ai.mq.north
 *
 * @Title: DeviceRegisterConsumer.java
 * @Description: 消费者-注册设备返回数据
 *
 * @author SRD
...
public class DeviceRegisterConsumer {
	 ...
	 * @Fields log：日志
	 */
	private static final Logger log = LoggerFactory.getLogger(DeviceRegisterConsumer.class);
	...
	public void start() throws MQClientException {
		try {
			...
			String consumerGroup = MQConstant.C_G_NORTH_DEVICE_REGISTER;// 消费者分组
			String topicName = rocketTopicConfig.getTopicName();// 主题名称
			String tag = rocketTopicConfig.getTagDeviceRegisterNorth();// tag
				...
				public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs,
					...
					try {
						for (Message msg : msgs) {
							...
							log.info("消费者分组-注册设备返回数据【" + consumerGroup + "】，主题topic【" + msg.getTopic() + "】，tag【" + tag
									+ "】，消费消息【" + body + "】");
