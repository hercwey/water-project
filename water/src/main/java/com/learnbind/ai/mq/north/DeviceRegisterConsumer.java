...
public class DeviceRegisterConsumer extends BaseConsumer {
	...
	public void initParams() {
		this.consumerGroup = MQConstant.C_G_NORTH_DEVICE_REGISTER;// 消费者分组
		this.topicName = rocketTopicConfig.getTopicName();// 主题名称
		this.tag = rocketTopicConfig.getTagDeviceRegisterNorth();// tag
	}
	@Override
	public void processMessage(String msg) {
		RegisterDeviceResponse registerDeviceRsp = RegisterDeviceResponse.fromJson(msg);
