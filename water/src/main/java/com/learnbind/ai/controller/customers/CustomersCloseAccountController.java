 ...
 * @Package com.learnbind.ai.controller.customers
 *
 * @Title: CustomersCloseAccountController.java
 * @Description: 客户档案-销户
 *
 * @author Thinkpad
 * @date 2019年9月15日 下午5:10:27
 * @version V1.0 
 *
 */
@Controller
@RequestMapping(value = "/customers-close-account")
public class CustomersCloseAccountController {
	
	//private static Log log = LogFactory.getLog(CustomersCloseAccountController.class);
	private static final String TEMPLATE_PATH = "customers/close_account/"; // 页面目录角色
