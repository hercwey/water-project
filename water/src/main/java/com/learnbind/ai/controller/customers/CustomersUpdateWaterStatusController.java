 ...
 * @Package com.learnbind.ai.controller.customers
 *
 * @Title: CustomersUpdateWaterStatusController.java
 * @Description: 客户档案-停/复水
 *
 * @author Thinkpad
 * @date 2019年9月15日 下午5:35:03
 * @version V1.0 
 *
 */
@Controller
@RequestMapping(value = "/customers-update-water-status")
public class CustomersUpdateWaterStatusController {
	
	//private static Log log = LogFactory.getLog(CustomersUpdateWaterStatusController.class);
	private static final String TEMPLATE_PATH = "customers/update_water_status/"; // 页面目录角色
