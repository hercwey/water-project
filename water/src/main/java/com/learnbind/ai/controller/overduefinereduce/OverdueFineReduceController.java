package com.learnbind.ai.controller.overduefinereduce;
 ...
 * @Package com.learnbind.ai.controller.overduefinereduce
 *
 * @Title: OverdueFineReduceController.java
 * @Description: 违约金减免控制器
 *
 * @author Administrator
 * @date 2019年7月6日 下午8:02:16
 * @version V1.0 
 *
 */
@Controller
@RequestMapping(value = "/overdue-fine-reduce")
public class OverdueFineReduceController {
	private static Log log = LogFactory.getLog(OverdueFineReduceController.class);
	private static final String TEMPLATE_PATH = "overdue_fine_reduce/"; // 页面目录
