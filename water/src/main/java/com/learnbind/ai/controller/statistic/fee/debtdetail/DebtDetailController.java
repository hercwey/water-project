package com.learnbind.ai.controller.statistic.fee.debtdetail;
 ...
 * @Package com.learnbind.ai.controller.statistic.fee.debtdetail
 *
 * @Title: DebtDetailController.java
 * @Description: 欠费-详情
 *
 * @author lenovo
 * @date 2019年9月7日 上午7:19:01
 * @version V1.0 
 *
 */
@Controller
...
public class DebtDetailController {
	private static Log log = LogFactory.getLog(DebtDetailController.class);
	private static final String TEMPLATE_PATH = "statistic/fee/debtdetail/"; // 页面目录
	...
	//------------------欠费详情,指定时间段内-------------------
		...
		@RequestMapping(value = "/fee/debtdetail/main")
		public String statisticFeeDebtDetailMain(Model model) {
			return TEMPLATE_PATH + "statistic_fee_debtdetail_main";
		}
		
		/**
		 * @Title: statisticFeeDebtDetailTable
		 * @Description: 		查询-指定期间的欠费客户列表列表
		 * @param pageNum  		页号
		 * @param pageSize 		页大小
		 ...
		 * @return 
		 */
		@RequestMapping(value = "/fee/debtdetail/table")
		public String statisticFeeDebtDetailTable(Integer pageNum, 
												  Integer pageSize,
												  String searchCond, 
												  Model model) {
			// 判定页码有效性
			...
			//欠费数据详情列表
			accountItemList=statisticService.searchDebtDetailList(periodStart,periodEnd, traceIds);  //查询指定期间的欠费数据列表			
		 ...
		 * accountItemSumList=statisticService.statReceivableSum(periodStart,periodEnd);
		 * //查询合计 if((Map<String,Object>)accountItemSumList.get(0)==null) {
		 ...
		 */			
			...
			return TEMPLATE_PATH+"statistic_fee_debtdetail_table";
		}
		
		/**
		 * @Title: statisticWaterMonthAmountChart
		 * @Description: 欠费详情-统计   (按每天的售水量进行统计)   柱状图
		 * @param period  期间  yyyy-mm
		 * @param model
		 * @return 
		 *  //TODO 暂未处理
		 */
		@RequestMapping(value = "/fee/debtdetail/chart")
		public String statisticWaterMonthAmountChart(String searchCond, Model model) {
			...
			return TEMPLATE_PATH + "statistic_fee_debtdetail_bar";
