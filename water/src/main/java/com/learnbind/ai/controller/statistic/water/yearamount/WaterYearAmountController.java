 ...
 * @Package com.learnbind.ai.controller.statistic.water.yearamount
 *
 * @Title: WaterYearAmountController.java
 * @Description: 年售水量-统计
 *
 * @author lenovo
 * @date 2019年9月1日 下午6:05:31
 * @version V1.0 
 *
 */
@Controller
@RequestMapping(value = "/stat")
public class WaterYearAmountController {
	private static Log log = LogFactory.getLog(WaterYearAmountController.class);
	private static final String TEMPLATE_PATH = "statistic/water/yearamount/"; // 页面目录
	...
	//------------------售水量汇总-年------------------------
		 ...
		 * @return 
		 */
		@RequestMapping(value = "/water/yearamount/main")
		public String statisticWaterYearAmountMain(Model model) {
			return TEMPLATE_PATH + "statistic_water_year_amount_main";
		}
		 ...
		 * @return 
		 */
		@RequestMapping(value = "/water/yearamount/table")
		public String statisticWaterYearAmountTable(Integer pageNum, 
												  Integer pageSize,
												  String searchCond, 
												  Model model) {
			// 判定页码有效性
			...
			return TEMPLATE_PATH+"statistic_water_year_amount_table";
		}
		 ...
		 * @return 
		 */
		@RequestMapping(value = "/water/yearamount/chart")
		public String statisticWaterYearAmountChart(String searchCond, Model model) {
			JSONObject parmsObj = JSON.parseObject(searchCond);
			String traceIds = parmsObj.getString("traceIds");//地理位置traceIds
			String period = parmsObj.getString("period");//期间
			List<String> dayList = genXAxisDataYear(); // 月份列表 x轴(数据)
			List<Integer> numPerDayList = statWaterAmountPerMonth(period, traceIds); // 每月所售水量列表 y轴(数据)
			...
			return TEMPLATE_PATH + "statistic_water_year_amount_bar";
		 ...
		 * @return 月--->水量
		 */
		private List<Integer> statWaterAmountPerMonth(String period, String traceIds) {
