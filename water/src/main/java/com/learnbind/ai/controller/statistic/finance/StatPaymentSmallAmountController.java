 ...
 * @Package com.learnbind.ai.controller.statistic.finance
 *
 * @Title: StatPaymentSmallAmountController.java
 * @Description: 缴费-小额统计
 *
 ...
 */
@Controller
@RequestMapping(value = "/stat-payment-small-amount")
public class StatPaymentSmallAmountController {
	private static Log log = LogFactory.getLog(StatPaymentSmallAmountController.class);
	private static final String TEMPLATE_PATH = "statistic/finance/paymentsmallamount/"; // 页面目录
