 ...
 * @Package com.learnbind.ai.controller.customers
 *
 * @Title: CustomersAgreeMentManageController.java
 * @Description: 客户档案-客户协议管理
 *
 * @author Thinkpad
 * @date 2019年9月15日 下午6:02:32
 * @version V1.0 
 *
 */
@Controller
@RequestMapping(value = "/customers-agreement-manage")
public class CustomersAgreeMentManageController {
	
	//private static Log log = LogFactory.getLog(CustomersAgreeMentManageController.class);
	private static final String TEMPLATE_PATH = "customers/agreement_manage/"; // 页面目录角色
