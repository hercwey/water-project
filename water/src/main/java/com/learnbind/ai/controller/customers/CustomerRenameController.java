...
public class CustomerRenameController {
	
	//private static Log log = LogFactory.getLog(CustomerRenameController.class);
	private static final String TEMPLATE_PATH = "customers/rename/"; // 页面目录角色
	...
	*	@throws 
	*/
	@RequestMapping(value = "/loadmodirenamedialog")
	public String loadModiCustomerDialog(Long itemId, Model model) {
		...
		return TEMPLATE_PATH + "rename_dialog_edit";
	}
