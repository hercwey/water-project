 ...
 */
@Configuration
@PropertySource(value = {"classpath:config/topic.properties" })
public class RocketTopicConfig {
    ...
    private String tagDeviceRegisterSouth;//注册设备请求
    @Value("${tag.device.update.south}")
    private String tagDeviceUpdateSouth;//修改设备请求
    @Value("${tag.device.delete.south}")
    private String tagDeviceDeleteSouth;//删除设备请求
    @Value("${tag.device.query.south}")
    private String tagDeviceQuerySouth;//查询设备请求
    @Value("${tag.device.register.north}")
    private String tagDeviceRegisterNorth;//注册设备响应
    @Value("${tag.device.update.north}")
    private String tagDeviceUpdateNorth;//修改设备响应
    @Value("${tag.device.delete.north}")
    private String tagDeviceDeleteNorth;//删除设备响应
